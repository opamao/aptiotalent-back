									...
									<ul class="nav-menu">
										...
										<li class="submenu">
											...
											<ul>
												...
												<li class="submenu">
													<a href="#" class="active subdrop"><span>Content</span> <span class="menu-arrow"></span></a>
													<ul>
														<li><a href="pages.html">Pages</a></li>
														<li class="submenu">
															<a href="javascript:void(0);"  class="active subdrop">Blogs<span class="menu-arrow"></span></a>
															<ul>
																<li><a href="blogs.html"  class="active">All Blogs</a></li>
				...
				<div class="twocol-mini">
					...
					<div class="sidebar-left slimscroll">
						<div class="nav flex-column align-items-center nav-pills" id="sidebar-tabs" role="tablist"
							...
							<a href="#" class="nav-link active" title="Content" data-bs-toggle="tab" data-bs-target="#content">
						...
						<div class="stack-menu">
							<div class="nav flex-column align-items-center nav-pills" role="tablist" aria-orientation="vertical">
								<div class="row g-2">
									...
									<div class="col-6">
										<a href="#menu-content" role="tab" class="nav-link active" title="Content" data-bs-toggle="tab" data-bs-target="#menu-content" aria-selected="false">
							...
							<div class="tab-content">
								...
								<div class="tab-pane fade  show active" id="menu-content">
									<ul class="stack-submenu">
										<li><a href="pages.html">Pages</a></li>
										<li class="submenu">
				...
				<div class="row justify-content-center">
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="img-sec w-100 position-relative mb-3">
                                    <a href="blog-categories.html"><img src="assets/img/blogs/blog-01.jpg" class="img-fluid rounded w-100" alt="img"></a>
                                    <div class="">
                                        <a href="blog-categories.html" class="trend-tag badge bg-info-transparent fs-10 fw-medium">Evlovution</a>
                                ...
                                <div class="border-bottom mb-3">
                                    <h5 class="mb-3">
                                        <a href="blog-categories.html" class="fs-16 fw-medium text-truncate">The Evolution of HRMS: Manual to Digital</a>
                                    </h5>                                   
                                </div>   
                    ...
                    <div class="col-xxl-4 col-md-6">
                        <div class="card">
                            <div class="card-body">
                                <div class="img-sec w-100 position-relative mb-3">
                                    <a href="blog-categories.html"><img src="assets/img/blogs/blog-02.jpg" class="img-fluid rounded w-100" alt="img"></a>
                                    <div class="">
                                        <a href="blog-categories.html" class="trend-tag badge bg-info-transparent fs-10 fw-medium">Guide</a>
                                        <span class="badge badge-success dot-icon"><i class="ti ti-point-filled"></i> Active</span>
                                    </div>
                                </div>   
                                <div class="d-flex align-items-center justify-content-between mb-3">
                                ...
                                <div class="border-bottom mb-3">
                                    <h5 class="mb-3">
                                        <a href="blog-categories.html" class="fs-16 fw-medium text-truncate">HRMS Implementation: Step-by-Step Guide</a>
                                    </h5>                                   
                                </div>   
                                <div class="d-flex align-items-center justify-content-between text-center">
                                    <div class="me-3">
                    ...
                    <div class="col-xxl-4 col-md-6">
                        <div class="card">
                            <div class="card-body">
                                <div class="img-sec w-100 position-relative mb-3">
                                    <a href="blog-categories.html"><img src="assets/img/blogs/blog-03.jpg" class="img-fluid rounded w-100" alt="img"></a>
                                    <div class="">
                                        <a href="blog-categories.html" class="trend-tag badge bg-info-transparent fs-10 fw-medium">Security</a>
                                        <span class="badge badge-success dot-icon"><i class="ti ti-point-filled"></i> Active</span>
                                    </div>
                                </div>   
                                <div class="d-flex align-items-center justify-content-between mb-3">
                                ...
                                <div class="border-bottom mb-3">
                                    <h5 class="mb-3">
                                        <a href="blog-categories.html" class="fs-16 fw-medium text-truncate"> Data Security in HRMS: What Matters</a>
                                    </h5>                                   
                                </div>   
                                <div class="d-flex align-items-center justify-content-between text-center">
                                    <div class="me-3">
                    ...
                    <div class="col-xxl-4 col-md-6">
                        <div class="card">
                            <div class="card-body">
                                <div class="img-sec w-100 position-relative mb-3">
                                    <a href="blog-categories.html"><img src="assets/img/blogs/blog-04.jpg" class="img-fluid rounded w-100" alt="img"></a>
                                    <div class="">
                                        <a href="blog-categories.html" class="trend-tag badge bg-info-transparent fs-10 fw-medium">Recruitment</a>
                                        <span class="badge badge-success dot-icon"><i class="ti ti-point-filled"></i> Active</span>
                                    </div>
                                </div>   
                                <div class="d-flex align-items-center justify-content-between mb-3">
                                ...
                                <div class="border-bottom mb-3">
                                    <h5 class="mb-3">
                                        <a href="blog-categories.html" class="fs-16 fw-medium text-truncate">  Improving Recruitment with HRMS</a>
                                    </h5>                                   
                                </div>   
                                <div class="d-flex align-items-center justify-content-between text-center">
                                    <div class="me-3">
                    ...
                    <div class="col-xxl-4 col-md-6">
                        <div class="card">
                            <div class="card-body">
                                <div class="img-sec w-100 position-relative mb-3">
                                    <a href="blog-categories.html"><img src="assets/img/blogs/blog-05.jpg" class="img-fluid rounded w-100" alt="img"></a>
                                    <div class="">
                                        <a href="blog-categories.html" class="trend-tag badge bg-info-transparent fs-10 fw-medium">Implementation</a>
                                        <span class="badge badge-success dot-icon"><i class="ti ti-point-filled"></i> Active</span>
                                    </div>
                                </div>   
                                <div class="d-flex align-items-center justify-content-between mb-3">
                                ...
                                <div class="border-bottom mb-3">
                                    <h5 class="mb-3">
                                        <a href="blog-categories.html" class="fs-16 fw-medium text-truncate"> Impact of HRMS on Company Culture</a>
                                    </h5>                                   
                                </div>   
                                <div class="d-flex align-items-center justify-content-between text-center">
                                    <div class="me-3">
                    ...
                    <div class="col-xxl-4 col-md-6">
                        <div class="card">
                            <div class="card-body">
                                <div class="img-sec w-100 position-relative mb-3">
                                    <a href="blog-categories.html"><img src="assets/img/blogs/blog-06.jpg" class="img-fluid rounded w-100" alt="img"></a>
                                    <div class="">
                                        <a href="blog-categories.html" class="trend-tag badge bg-info-transparent fs-10 fw-medium">Benefits</a>
                                        <span class="badge badge-success dot-icon"><i class="ti ti-point-filled"></i> Active</span>
                                    </div>
                                </div>   
                                <div class="d-flex align-items-center justify-content-between mb-3">
                                ...
                                <div class="border-bottom mb-3">
                                    <h5 class="mb-3">
                                        <a href="blog-categories.html" class="fs-16 fw-medium text-truncate">Key Benefits of Implementing HRMS</a>
                                    </h5>                                   
                                </div>   
                                <div class="d-flex align-items-center justify-content-between text-center">
                                    <div class="me-3">
                    ...
                    <div class="col-xxl-4 col-md-6">
                        <div class="card">
                            <div class="card-body">
                                <div class="img-sec w-100 position-relative mb-3">
                                    <a href="blog-categories.html"><img src="assets/img/blogs/blog-07.jpg" class="img-fluid rounded w-100" alt="img"></a>
                                    <div class="">
                                        <a href="blog-categories.html" class="trend-tag badge bg-info-transparent fs-10 fw-medium">Management</a>
                                        <span class="badge badge-success dot-icon"><i class="ti ti-point-filled"></i> Active</span>
                                    </div>
                                </div>   
                                <div class="d-flex align-items-center justify-content-between mb-3">
                                ...
                                <div class="border-bottom mb-3">
                                    <h5 class="mb-3">
                                        <a href="blog-categories.html" class="fs-16 fw-medium text-truncate">Why Your Company Needs a HRMS</a>
                                    </h5>                                   
                                </div>   
                                <div class="d-flex align-items-center justify-content-between text-center">
                                    <div class="me-3">
                    ...
                    <div class="col-xxl-4 col-md-6">
                        <div class="card">
                            <div class="card-body">
                                <div class="img-sec w-100 position-relative mb-3">
                                    <a href="blog-categories.html"><img src="assets/img/blogs/blog-08.jpg" class="img-fluid rounded w-100" alt="img"></a>
                                    <div class="">
                                        <a href="blog-categories.html" class="trend-tag badge bg-info-transparent fs-10 fw-medium">Management</a>
                                        <span class="badge badge-success dot-icon"><i class="ti ti-point-filled"></i> Active</span>
                                    </div>
                                ...
                                <div class="border-bottom mb-3">
                                    <h5 class="mb-3">
                                        <a href="blog-categories.html" class="fs-16 fw-medium text-truncate">Scaling Your HR Operations with HRMS</a>
                                    </h5>                                   
                                </div>   
                                <div class="d-flex align-items-center justify-content-between text-center">
                                    <div class="me-3">
                    ...
                    <div class="col-xxl-4 col-md-6">
                        <div class="card">
                            <div class="card-body">
                                <div class="img-sec w-100 position-relative mb-3">
                                    <a href="blog-categories.html"><img src="assets/img/blogs/blog-09.jpg" class="img-fluid rounded w-100" alt="img"></a>
                                    <div class="">
                                        <a href="blog-categories.html" class="trend-tag badge bg-info-transparent fs-10 fw-medium">Management</a>
                                        <span class="badge badge-success dot-icon"><i class="ti ti-point-filled"></i> Active</span>
                                    </div>
                                ...
                                <div class="border-bottom mb-3">
                                    <h5 class="mb-3">
                                        <a href="blog-categories.html" class="fs-16 fw-medium text-truncate">How HRMS Drives Organizational Success</a>
                                    </h5>                                   
                                </div>   
                                <div class="d-flex align-items-center justify-content-between text-center">
                                    <div class="me-3">
