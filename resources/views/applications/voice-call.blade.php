                                ...
                                <div class="main-menu">
                                    <ul class="nav-menu">
                                        ...
                                        <li class="submenu">
                                            ...
                                            <ul>
                                                ...
                                                <li class="submenu submenu-two">
                                                    <a href="call.html" class="active">Calls<span class="menu-arrow inside-submenu"></span></a>
                                                    <ul>
                                                        <li><a href="voice-call.html" class="active">Voice Call</a></li>
                                        ...
                                        <li class="submenu">
                                            ...
                                            <ul>
                                                <li>
                                                    <a href="clients-grid.html"><span>Clients</span></a>
                                                </li>
                                                <li class="submenu">
                                            ...
                                            <div class="border-bottom mb-3 pb-3">
                                                <a href="activity.html">
                                                    <div class="d-flex">
                                                        ...
                                                        <div class="flex-grow-1">
                                                            <p class="mb-1">New student record <span class="text-dark fw-semibold"> George</span> is created by <span class="text-dark fw-semibold">Teressa</span>
                                                            </p>
                                                            <span>2 hrs ago</span>
                                                        </div>
                                                    </div>
                            ...
                            <ul>
                                ...
                                <li class="submenu">
                                    ...
                                    <ul>
                                        <li><a href="chat.html">Chat</a></li>
                                        <li class="submenu submenu-two">
                                            <a href="call.html" class="active subdrop">Calls<span class="menu-arrow inside-submenu"></span></a>
                                            <ul>
                                                <li><a href="voice-call.html" class="active">Voice Call</a></li>
                                                <li><a href="video-call.html">Video Call</a></li>
                                                <li><a href="outgoing-call.html">Outgoing Call</a></li>
