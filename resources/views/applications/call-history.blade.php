										...
										<li class="submenu">
											...
											<ul>
												...
												<li class="submenu submenu-two">
													<a href="call.html" class="active">Calls<span
							...
							<ul>
								...
								<li class="submenu">
									...
									<ul> 
										<li><a href="chat.html">Chat</a></li>
										<li class="submenu submenu-two">
											<a href="call.html" class="active subdrop">Calls<span
													class="menu-arrow inside-submenu"></span></a>
											<ul>
												<li><a href="voice-call.html" >Voice Call</a></li>
												<li><a href="video-call.html">Video Call</a></li>
							...
							<div class="card bg-light-500">
								<div class="card-body">
									...
									<div class="d-flex align-items-center justify-content-center">
										<a href="video-call.html" class="btn btn-gray call-item p-0 d-flex align-items-center justify-content-center me-3"><i class="ti ti-video fs-20"></i></a>
										<a href="chat.html" class="btn btn-gray call-item p-0 d-flex align-items-center justify-content-center me-3"><i class="ti ti-message fs-20"></i></a>
										<a href="voice-call.html" class="btn btn-gray call-item p-0 d-flex align-items-center justify-content-center"><i class="ti ti-phone fs-20"></i></a>
									</div>
								</div>
							</div>
							<div class="row g-4">
