                                    ...
                                    <ul class="nav-menu">
                                        ...
                                        <li class="submenu">
                                            ...
                                            <ul>
                                                ...
                                                <li><a href="terms-condition.html" class="active"><span>Terms & Conditions</span></a></li>
                                                <li class="submenu">
                        ...
                        <div class="stack-menu">
                            <div class="nav flex-column align-items-center nav-pills" role="tablist" aria-orientation="vertical">
                                <div class="row g-2">
                                    ...
                                    <div class="col-6">
                                        <a href="#menu-pages" role="tab" class="nav-link active" title="Pages" data-bs-toggle="tab" data-bs-target="#menu-pages" aria-selected="false">
                            ...
                            <div class="tab-content">
                                ...
                                <div class="tab-pane fade show active" id="menu-pages">
                                    <ul class="stack-submenu">
                                        ...
                                        <li><a href="terms-condition.html" class="active">Terms & Conditions</a></li>
                                    </ul>
                                </div>
