													...
													<ul>
														...
														<li class="submenu">
															...
															<ul>
																...
																<li><a href="currencies.html" class="active">Currencies</a></li>
															</ul>
														</li>
														<li class="submenu">
						...
						<div class="card">
							<div class="card-body">
								<div class="d-flex flex-column list-group settings-list">
									<a href="payment-gateways.html" class="d-inline-flex align-items-center rounded py-2 px-3">Payment Gateways</a>
									<a href="tax-rates.html" class="d-inline-flex align-items-center rounded py-2 px-3">Tax Rates</a>
									<a href="currencies.html" class="d-inline-flex align-items-center active rounded py-2 px-3"><i class="ti ti-arrow-badge-right me-2"></i>Currencies</a>
								</div>
							</div>
						</div>
					</div>
