											...
											<ul>
												...
												<li class="submenu">
													...
													<ul>
														...
														<li class="submenu">
															<a href="javascript:void(0);" class="active subdrop">Financial Settings<span
																	class="menu-arrow"></span></a>
															<ul>
																<li><a href="payment-gateways.html" class="active">Payment Gateways</a>
																</li>
									...
									<ul>
										...
										<li class="submenu submenu-two">
											<a href="javascript:void(0);"class="active subdrop">Financial Settings<span
													class="menu-arrow inside-submenu"></span></a>
											<ul>
												<li><a href="payment-gateways.html" class="active">Payment Gateways</a></li>
												<li><a href="tax-rates.html">Tax Rate</a></li>
												<li><a href="currencies.html">Currencies</a></li>
											</ul>
										</li>
		...
		<div class="page-wrapper">
			<div class="content">
				...
				<ul class="nav nav-tabs nav-tabs-solid bg-transparent border-bottom mb-3">
					...
					<li class="nav-item">
						<a class="nav-link active" href="payment-gateways.html"><i class="ti ti-settings-dollar me-2"></i>Financial Settings</a>
					</li>
					<li class="nav-item">
						...
						<div class="card">
							<div class="card-body">
								<div class="d-flex flex-column list-group settings-list">
									<a href="payment-gateways.html" class="d-inline-flex align-items-center active rounded py-2 px-3"><i class="ti ti-arrow-badge-right me-2"></i>Payment Gateways</a>
									<a href="tax-rates.html" class="d-inline-flex align-items-center rounded py-2 px-3">Tax Rates</a>
									<a href="currencies.html" class="d-inline-flex align-items-center rounded py-2 px-3">Currencies</a>
								</div>
							</div>
						</div>
					</div>
