											...
											<ul>
												...
												<li class="submenu">
													...
													<ul>
														...
														<li class="submenu">
															<a href="javascript:void(0);" class="active subdrop">System Settings<span
																	class="menu-arrow"></span></a>
															<ul>
																<li><a href="email-settings.html">Email Settings</a>
																</li>
																<li><a href="email-template.html" class="active">Email Templates</a>
																</li>
									...
									<ul>
										...
										<li class="submenu submenu-two">
											...
											<ul>
												...
												<li><a href="email-template.html" class="active">Email Templates</a></li>
												<li><a href="sms-settings.html">SMS Settings</a></li>
												<li><a href="sms-template.html">SMS Templates</a></li>
												<li><a href="otp-settings.html">OTP</a></li>
												<li><a href="gdpr.html">GDPR Cookies</a></li>
		...
		<div class="page-wrapper">
			<div class="content">
				...
				<ul class="nav nav-tabs nav-tabs-solid bg-transparent border-bottom mb-3">
					...
					<li class="nav-item">
						<a class="nav-link active" href="email-settings.html"><i class="ti ti-server-cog me-2"></i>System Settings</a>
					</li>
					<li class="nav-item">
						...
						<div class="card">
							<div class="card-body">
								<div class="d-flex flex-column list-group settings-list">
                                    <a href="email-settings.html" class="d-inline-flex align-items-center rounded  py-2 px-3">Salary Settings</a>
									<a href="email-template.html" class="d-inline-flex align-items-center rounded  active py-2 px-3"><i class="ti ti-arrow-badge-right me-2"></i>Email Templates</a>
									<a href="sms-settings.html" class="d-inline-flex align-items-center rounded py-2 px-3">SMS Settings</a>
									<a href="sms-template.html" class="d-inline-flex align-items-center rounded py-2 px-3">SMS Templates</a>
                                    <a href="otp-settings.html" class="d-inline-flex align-items-center rounded py-2 px-3">OTP</a>
                                    <a href="gdpr-cookies.html" class="d-inline-flex align-items-center rounded py-2 px-3">GDPR Cookies</a>
                                    <a href="maintenance-mode.html" class="d-inline-flex align-items-center rounded py-2 px-3">Maintenance Mode</a>
