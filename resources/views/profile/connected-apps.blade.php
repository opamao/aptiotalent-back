													...
													<ul>
														<li class="submenu">
															...
															<ul>
																...
																<li><a href="connected-apps.html" class="active">Connected Apps</a>
																</li>
															</ul>
														</li>
														<li class="submenu">
									...
									<ul>
										<li class="submenu submenu-two">
											...
											<ul>
												...
												<li><a href="connected-apps.html" class="active">Connected Apps</a></li>
											</ul>
										</li>
										<li class="submenu submenu-two">
											<a href="javascript:void(0);">Website Settings<span
						...
						<div class="card">
							<div class="card-body">
								<div class="d-flex flex-column list-group settings-list">
									...
									<a href="notification-settings.html" class="d-inline-flex align-items-center rounded py-2 px-3">Notifications</a>
									<a href="connected-apps.html" class="d-inline-flex align-items-center rounded active py-2 px-3"><i class="ti ti-arrow-badge-right me-2"></i>Connected Apps</a>
								</div>
							</div>
						</div>
					</div>
