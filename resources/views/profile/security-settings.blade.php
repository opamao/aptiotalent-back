													...
													<ul>
														<li class="submenu">
															...
															<ul>
																...
																<li><a href="security-settings.html" class="active">Security</a></li>
																<li><a
						...
						<div class="card">
							<div class="card-body">
								<div class="d-flex flex-column list-group settings-list">
									...
									<a href="security-settings.html" class="d-inline-flex align-items-center rounded active py-2 px-3"><i class="ti ti-arrow-badge-right me-2"></i>Security Settings</a>
