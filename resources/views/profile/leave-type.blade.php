											...
											<ul>
												...
												<li class="submenu">
													...
													<ul>
														...
														<li class="submenu">
															<a href="javascript:void(0);" class="active subdrop">App Settings<span
																	class="menu-arrow"></span></a>
															<ul>
																...
																<li><a href="leave-type.html" class="active">Leave Type</a></li>
						...
						<div class="tab-content" id="v-pills-tabContent">
							...
							<div class="tab-pane fade show active" id="administration">
								<ul>
									...
									<li class="submenu">
										<a href="javascript:void(0);" class="active subdrop">App Settings<span class="menu-arrow"></span></a>
										<ul>
											<li><a href="salary-settings.html">Salary Settings</a></li>
											<li><a href="approval-settings.html">Approval Settings</a></li>
											<li><a href="invoice-settings.html">Invoice Settings</a></li>
		...
		<div class="page-wrapper">
			<div class="content">
				...
				<ul class="nav nav-tabs nav-tabs-solid bg-transparent border-bottom mb-3">
					...
					<li class="nav-item">
						<a class="nav-link active" href="salary-settings.html"><i class="ti ti-device-ipad-horizontal-cog me-2"></i>App Settings</a>
					</li>
					<li class="nav-item">
						...
						<div class="card">
							<div class="card-body">
								<div class="d-flex flex-column list-group settings-list">
									<a href="salary-settings.html" class="d-inline-flex align-items-center rounded  py-2 px-3">Salary Settings</a>
									<a href="approval-settings.html" class="d-inline-flex align-items-center rounded py-2 px-3">Approval Settings</a>
									<a href="invoice-settings.html" class="d-inline-flex align-items-center rounded py-2 px-3">Invoice Settings</a>
									<a href="leave-type.html" class="d-inline-flex align-items-center rounded active py-2 px-3"><i class="ti ti-arrow-badge-right me-2"></i>Leave Type</a>
                                    <a href="custom-fields.html" class="d-inline-flex align-items-center rounded py-2 px-3">Custom Fields</a>
								</div>
							</div>
						</div>
					</div>
