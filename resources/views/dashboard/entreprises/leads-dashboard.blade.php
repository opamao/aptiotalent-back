									...
									<ul class="nav-menu">
										...
										<li class="submenu">
											...
											<ul>
												...
												<li><a href="leads-dashboard.html" class="active">Leads Dashboard</a></li>
											</ul>
										</li>
										<li class="submenu">
											<a href="#">
							...
							<div class="card-body schedule-timeline activity-timeline">
								<div class="d-flex align-items-start">
									...
									<div class="flex-fill ps-3 pb-4 timeline-flow">
										<p class="fw-medium text-gray-9 mb-1"><a href="activity.html">Drain responded to your appointment schedule question.</a></p>
										<span>09:25 PM</span>
									</div>
								</div>
								<div class="d-flex align-items-start">
									...
									<div class="flex-fill ps-3 pb-4 timeline-flow">
										<p class="fw-medium text-gray-9 mb-1"><a href="activity.html">You sent 1 Message to the James.</a></p>
										<span>10:25 PM</span>
									</div>
								</div>
								<div class="d-flex align-items-start">
									...
									<div class="flex-fill ps-3 pb-4 timeline-flow">
										<p class="fw-medium text-gray-9 mb-1"><a href="activity.html">Denwar responded to your appointment on 25 Jan 2025, 08:15 PM</a></p>
										<span>09:25 PM</span>
									</div>
								</div>
								<div class="d-flex align-items-start">
									...
									<div class="flex-fill ps-3 timeline-flow">
										<p class="fw-medium text-gray-9 mb-1"><a href="activity.html" class="d-flex align-items-center">Meeting With <img src="assets/img/users/user-58.jpg" class="avatar avatar-sm rounded-circle mx-2" alt="Img">Abraham</a></p>
										<span>09:25 PM</span>
									</div>
								</div>
							</div>
									...
									<div class="col-xxl-5 col-sm-6">
										<div class="pe-3 border-end">
											<div class="d-flex align-items-center mb-4">
												...
												<div class="ms-2">
													<h6 class="fw-medium text-truncate mb-1"><a href="countries.html">Singapore</a></h6>
											...
											<div class="d-flex align-items-center mb-4">
												...
												<div class="ms-2">
													<h6 class="fw-medium text-truncate mb-1"><a href="countries.html">France</a></h6>
											...
											<div class="d-flex align-items-center mb-4">
												...
												<div class="ms-2">
													<h6 class="fw-medium text-truncate mb-1"><a href="countries.html">Norway</a></h6>
							...
							<div class="card-body p-0">
								<div class="table-responsive">	
									<table class="table table-nowrap dashboard-table mb-0">
										...
										<tbody>
											<tr>
												<td><h6 class="fw-medium"><a href="leads-details.html">Collins</a></h6></td>
												<td>
													<div class="d-flex align-items-center file-name-icon">
														...
														<div class="ms-2">
															<h6 class="fw-medium"><a href="company-details.html">BrightWave Innovations</a></h6>
														</div>
													</div>
												</td>
												<td>
											...
											<tr>
												<td><h6 class="fw-medium"><a href="leads-details.html">Konopelski</a></h6></td>
												<td>
													<div class="d-flex align-items-center file-name-icon">
														<a href="company-details.html" class="avatar border rounded-circle">
														...
														<div class="ms-2">
															<h6 class="fw-medium"><a href="company-details.html">Stellar Dynamics</a></h6>
														</div>
													</div>
												</td>
												<td>
											...
											<tr>
												<td><h6 class="fw-medium"><a href="leads-details.html">Adams</a></h6></td>
												<td>
													<div class="d-flex align-items-center file-name-icon">
														<a href="company-details.html" class="avatar border rounded-circle">
														...
														<div class="ms-2">
															<h6 class="fw-medium"><a href="company-details.html">Quantum Nexus</a></h6>
														</div>
													</div>
												</td>
												<td>
											...
											<tr>
												<td><h6 class="fw-medium"><a href="leads-details.html">Schumm</a></h6></td>
												<td>
													<div class="d-flex align-items-center file-name-icon">
														<a href="company-details.html" class="avatar border rounded-circle">
														...
														<div class="ms-2">
															<h6 class="fw-medium"><a href="company-details.html">EcoVision Enterprises</a></h6>
														</div>
													</div>
												</td>
												<td>
											...
											<tr>
												<td><h6 class="fw-medium"><a href="leads-details.html">Wisozk</a></h6></td>
												<td>
													<div class="d-flex align-items-center file-name-icon">
														<a href="company-details.html" class="avatar border rounded-circle">
														...
														<div class="ms-2">
															<h6 class="fw-medium"><a href="company-details.html">Aurora Technologies</a></h6>
														</div>
													</div>
												</td>
												<td>
