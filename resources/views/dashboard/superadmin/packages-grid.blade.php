									...
									<ul class="nav-menu">
										...
										<li class="submenu">
											...
											<ul>
												...
												<li><a href="layout-stacked.html">Stcked</a></li>
					...
					<div class="sidebar-scroll">
						...
						<div class="stack-menu">
							<div class="nav flex-column align-items-center nav-pills" role="tablist" aria-orientation="vertical">
								<div class="row g-2">
									<div class="col-6">
										<a href="javascript:void(0);" role="tab" class="nav-link active" title="Dashboard" data-bs-toggle="tab" data-bs-target="#menu-dashboard" aria-selected="true">
									...
									<div class="col-6">
										<a href="javascript:void(0);" role="tab" class="nav-link" title="Pages" data-bs-toggle="tab" data-bs-target="#menu-pages" aria-selected="false">
									...
									<div class="col-6">
										<a href="javascript:void(0);" role="tab" class="nav-link" title="UI Elements" data-bs-toggle="tab" data-bs-target="#menu-ui-elements" aria-selected="false">
					...
					<div class="d-flex my-xl-auto right-content align-items-center flex-wrap ">
						<div class="me-2 mb-2">
							<div class="d-flex align-items-center border bg-white rounded p-1 me-2 icon-list">
								...
								<a href="packages-grid.html" class="btn btn-icon btn-sm bg-primary text-white active"><i class="ti ti-layout-grid"></i></a>
							</div>
						</div>
						<div class="me-2 mb-2">
							<div class="dropdown">
