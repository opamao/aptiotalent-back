								...
								<div class="main-menu">
									<ul class="nav-menu">
										...
										<li class="submenu">
											...
											<ul>
												<li class="submenu">
													<a href="javascript:void(0);" class="active"><span>Jobs</span></a>
												</li>
												<li class="submenu">
				...
				<div class="main-menu">
					<ul class="nav-menu">
						...
						<li class="submenu">
							...
							<ul>
								<li class="submenu">
									<a href="javascript:void(0);" class="active" ><span>Jobs</span>
						...
						<div class="tab-content" id="v-pills-tabContent">
							...
							<div class="tab-pane fade show active" id="hrm">
								<ul>
									...
									<li><a href="resignation.html"><span>Resignation</span></a></li>
									<li><a href="termination.html"><span>Termination</span></a></li>
									<li><a href="job-grid.html"  class="active"><span>Job</span></a></li>
								</ul>
							</div>
							...
							<div class="tab-content">
								...
								<div class="tab-pane fade show active" id="menu-hrm">
									<ul class="stack-submenu">
										...
										<li><a href="resignation.html"><span>Resignation</span></a></li>
										<li><a href="termination.html"><span>Termination</span></a></li>
										<li><a href="job-grid.html" class="active"><span>Jobs</span></a></li>
									</ul>
								</div>
					...
					<div class="d-flex my-xl-auto right-content align-items-center flex-wrap ">
						...
						<div class="me-2 mb-2">
							<div class="d-flex align-items-center border bg-white rounded p-1 me-2 icon-list">
								<a href="job-list.html" class="btn btn-icon btn-sm active bg-primary text-white me-1"><i class="ti ti-list-tree"></i></a>
