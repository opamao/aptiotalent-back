								...
								<div class="main-menu">
									<ul class="nav-menu">
										...
										<li class="submenu">
											...
											<ul>
												<li class="submenu">
													<a href="job-grid.html"><span>Jobs</span></a>
												</li>
												<li class="submenu">
													<a href="candidates-grid.html" class="active"><span>Candidates</span></a>
												</li>
												<li class="submenu">
												...
												<li class="submenu">
													...
													<ul>
														...
														<li class="submenu">
															<a href="javascript:void(0);">Website
				...
				<div class="main-menu">
					<ul class="nav-menu">
						...
						<li class="submenu">
							...
							<ul>
								<li class="submenu">
									<a href="job-list.html"><span>Jobs</span></a>

								</li>
								<li class="submenu">
									<a href="candidates.html" class="active"><span>Candidates</span></a>
								</li>
								<li class="submenu">
									<a href="javascript:void(0);"><span>Sales</span>
										<span class="menu-arrow"></span>
						...
						<div class="tab-content" id="v-pills-tabContent">
							...
							<div class="tab-pane fade show active" id="hrm">
								<ul>
									...
									<li><a href="resignation.html"><span>Resignation</span></a></li>
									<li><a href="termination.html"><span>Termination</span></a></li>
									<li><a href="job-list.html"><span>Job</span></a></li>
									<li ><a href="job-list.html" class="active"><span>Candidates</span></a></li>
								</ul>
							</div>
						...
						<div class="stack-menu">
							<div class="nav flex-column align-items-center nav-pills" role="tablist"
								...
								<div class="row g-2">
									...
									<div class="col-6">
										<a href="#menu-hrm" role="tab" class="nav-link active" title="HRM"
							...
							<div class="tab-content">
								...
								<div class="tab-pane fade show active" id="menu-hrm">
									<ul class="stack-submenu">
										...
										<li><a href="resignation.html"><span>Resignation</span></a></li>
										<li><a href="termination.html"><span>Termination</span></a></li>
										<li><a href="job-list.html"><span>Jobs</span></a></li>
										<li><a href="candidates.html" class="active"><span>Candidates</span></a></li>
									</ul>
								</div>
					...
					<div class="d-flex my-xl-auto right-content align-items-center flex-wrap">
						<div class="me-2 mb-2">
							<div class="d-flex align-items-center border bg-white rounded p-1 me-2 icon-list">
								...
								<a href="candidates.html" class="btn btn-icon btn-sm active bg-primary text-white me-1"><i class="ti ti-list-tree"></i></a>                                
								<a href="candidates-grid.html" class="btn btn-icon btn-sm"><i class="ti ti-layout-grid"></i></a>
							</div>
						</div>
						<div class="me-2 mb-2">
							<div class="dropdown">
